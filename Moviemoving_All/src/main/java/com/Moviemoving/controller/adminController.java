...
public class adminController {
	 ...
	 * //영화관리
	 * 
	 * @GetMapping("/movieList") public void list(Model model) {
	 * model.addAttribute("movieList", service.getList()); }
	 * 
	 * @GetMapping("/movieView") public void view(@RequestParam("MovieInfo_no") int
	 * MovieInfo_no, Model model) { log.info("성공" + MovieInfo_no);
	 * model.addAttribute("movie", service.getView(MovieInfo_no)); }
	 * 
	 * @PostMapping("/movieRemove") public String
	 * movieRemove(@RequestParam("MovieInfo_no") int MovieInfo_no) { log.info("성공" +
	 * MovieInfo_no);
	 * 
	 * service.deleteMovie(MovieInfo_no);
	 * 
