            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="mb-4">	
                        	<a href="/admin/register" class="btn btn-primary">등록</a>
                        </div>
                        <div class="card mb-4">
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <c:forEach items="${movieList}" var="movieList">
                                        <tr>
                                            ...
                                            <td>${movieList.movieInfo_visit}</td>
                                            <td >${movieList.movieInfo_con}</td>
                                            <td >${movieList.movieInfo_thum}</td>
                                            <td>${movieList.movieInfo_bkimg}</td>
                                            <td>${movieList.movieInfo_video}</td>
                                            <td>
								  ...
								  <div class="modal-dialog">
								    ...
								    <!-- <script>
								    	$(document).ready(function(){
								    		var result="${result}";
								    		checkModal(result);
								    		function checkModea(result){
								    			if(result==''){
								    				return;
								    			}
								    			if(paseInt(result)>0){
								    				$(".modal-body").html("영화정보"+parseInt(result)+"가 등록되었습니다.");
								    			}
								    			$("#myModel").moal("show");
								    		}
								    	});
