       ...
       <!-- 상단 시작 ----------->
        ...
        <div class="pop-wrap-bg login-pop">
            <div class="">
                ...
                <form action="/login" method="POST" class="resetForm">
        ...
        <div class="pop-wrap-bg join-pop">
            <div class="">
                ...
                <form action="register" method="POST" class="resetForm">
                    ...
                    <div class="idBox">
	                    ...
	                    <button class="overlapBtn sm-bt" type="button" id="overlapBtn"">중복확인</button>
                    </div>
